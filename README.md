...
Until this is on the Chrome Web Store, it installs as an unpacked extension:
...
Open [chatgpt.com](https://chatgpt.com) — you're set. There's no icon bar popup; the extension just enhances the page.
